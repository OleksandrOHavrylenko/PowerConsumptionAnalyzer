...
#docker exec broker-1 ./opt/kafka/bin/kafka-consumer-groups.sh --bootstrap-server broker-1:19092,broker-2:19092,broker-3:19092 --delete --group power-consumption-processor-anomalies-detected-store-changelog
#docker exec broker-1 ./opt/kafka/bin/kafka-consumer-groups.sh --bootstrap-server broker-1:19092,broker-2:19092,broker-3:19092 --delete --group power-consumption-processor-anomalies-detected-store-repatrition
...
docker exec broker-1 ./opt/kafka/bin/kafka-topics.sh --bootstrap-server broker-1:19092,broker-2:19092,broker-3:19092 --delete --topic power-consumption-processor-anomalies-detected-store-changelog
docker exec broker-1 ./opt/kafka/bin/kafka-topics.sh --bootstrap-server broker-1:19092,broker-2:19092,broker-3:19092 --delete --topic power-consumption-processor-anomalies-detected-store-repartition
